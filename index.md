...
- [Resolution and Routing](registries/resolution.md#resolution-and-routing)
  - [The resolver](registries/resolution.md#the-resolver)
  - [Resolution by DID method](registries/resolution.md#resolution-by-did-method)
    - [`did:web`](registries/resolution.md#didweb)
      - [Illustrative `did.json` Document for a Utility](registries/resolution.md#illustrative-didjson-document-for-a-utility)
    - [`did:key` and `did:jwk` (Offline Cryptographic)](registries/resolution.md#didkey-and-didjwk-offline-cryptographic)
    - [`did:dedi:<ns>:<reg>:<id>`](registries/resolution.md#diddedi)
  - [Unification of Public vs. Private Resolution Details](registries/resolution.md#unification-of-public-vs-private-resolution-details)
    - [The Two-Resolver Model](registries/resolution.md#the-two-resolver-model)
    - [Unification via `privateRef`](registries/resolution.md#unification-via-privateref)
  - [Workflow 1 — Verifying a credential](registries/resolution.md#workflow-1-verifying-a-credential)
  - [Workflow 2 — Issuing a credential](registries/resolution.md#workflow-2-issuing-a-credential)
  - [Workflow 3 — Routing a Beckn message](registries/resolution.md#workflow-3-routing-a-beckn-message)
  - [Workflow 4 — Cross-DISCOM consumer move](registries/resolution.md#workflow-4-cross-discom-consumer-move)
  - [Workflow 5 — Resolving an asset for an outage notification](registries/resolution.md#workflow-5-resolving-an-asset-for-an-outage-notification)
  - [Caching strategy](registries/resolution.md#caching-strategy)
  - [Error handling](registries/resolution.md#error-handling)
  - [SDK shape](registries/resolution.md#sdk-shape)
