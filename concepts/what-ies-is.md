...
| **2. [Discover](../what-ies-provides/discover-exchange.md)** | Before a data exchange, both systems look each other up, confirm the other is genuine, and agree on what will be exchanged and on what terms. No bilateral arrangement needed. | [Beckn protocol](https://becknprotocol.io) |
