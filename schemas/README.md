...
W3C VC payloads — signed, durable records the holder keeps and verifies independently of any network. Issuance, verification and revocation operations are in **[Issue Credentials](../how-you-implement-ies/issue-credentials.md)**.
