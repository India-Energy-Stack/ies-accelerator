...
| `status` | SCHEDULED / ACTIVE / PARTIALLY_RESTORED / RESTORED / CANCELLED | — | Mandatory |
| `msgType` | ALERT / UPDATE / CANCEL | OASIS CAP v1.2 (alert/msgType) | Optional |
| `references` | list of Identifier | OASIS CAP v1.2 (alert/references) | Optional |
| `severity` | EXTREME / SEVERE / MODERATE / MINOR / UNKNOWN | OASIS CAP v1.2 (info/severity) | Optional |
| `category` | MAINTENANCE / UPGRADE / FAULT / LOAD_SHEDDING / WEATHER / SAFETY / OTHER | — | Optional |
| `cause` | OutageCause | — | Optional |
| `forceMajeure` | yes / no | — | Optional |
| `issuedBy` | Party | — | Optional |
| `issuedAt` | date-time | — | Optional |
| `detectedAt` | date-time | — | Optional |
...
| Field | Type | Standard | Status |
|---|---|---|---|
| `category` | EQUIPMENT / LIGHTNING / PLANNED / POWER_SUPPLY / PUBLIC / VEGETATION / WEATHER / WILDLIFE / UNKNOWN / OTHER | IEEE 1782-2022 §4.4 (with IEEE 1366) | Optional |
| `subcategory` | DEGRADATION / EQUIPMENT_ERROR / ENVIRONMENTAL / DIRECT_STRIKE / INDIRECT_STRIKE / NEW_CONSTRUCTION / MAINTENANCE / CUSTOMER_REQUEST / OTHER_UTILITY_REQUEST / GENERATION / TRANSMISSION / SUBTRANSMISSION / DISTRIBUTION / DISTRIBUTED_GENERATION_STORAGE / OTHER_UTILITY_SUPPLY / DIG_IN / FOREIGN_CONTACT / FIRE_POLICE / VEHICLE / WITHIN_CLEARANCE_ZONE / OUTSIDE_CLEARANCE_ZONE / PRECIPITATION / ICE / WIND / EXTREME_TEMPERATURE / MAMMAL / BIRD / REPTILE_AMPHIBIAN / NO_SPECIFIC_CAUSE_FOUND / UTILITY_ERROR / OTHER_UTILITY_INITIATED / OTHER | IEEE 1782-2022 §4.5 | Optional |
| `faultType` | text | — | Optional |
| `code` | text | — | Optional |
| `codeNamespace` | text | — | Optional |
| `text` | text | — | Optional |
...
|---|---|---|---|
| `id` | Identifier | — | Mandatory |
| `assetLevel` | SUBSTATION / FEEDER / DT / LINE_SEGMENT / SERVICE_POINT | — | Mandatory |
| `voltageLevel` | text | — | Optional |
| `consumerCategory` | URBAN / RURAL / AGRICULTURE / INDUSTRIAL / MIXED / OTHER | — | Optional |
| `meterRef` | Identifier | — | Optional |
| `parentRef` | Identifier | — | Optional |
| `geo` | GeoJSONGeometry | GeoJSON (RFC 7946), WGS84 | Optional |
...
|---|---|---|---|
| `text` | text | — | Optional |
| `adminAreas` | list of text | — | Optional |
| `geo` | GeoJSONGeometry | GeoJSON (RFC 7946); CAP area | Optional |
...
| `deEnergized` | list of Identifier | CIM (IEC 61968-3 UsagePoint) | Optional |
| `energized` | list of Identifier | CIM (IEC 61968-3 UsagePoint) | Optional |

### OutageTiming

| Field | Type | Standard | Status |
|---|---|---|---|
| `period` | TimePeriod | — | Mandatory |
| `estimatedRestoration` | date-time | — | Optional |
| `actualRestoration` | date-time | — | Optional |
| `slaTargetMinutes` | integer | — | Optional |

### OutageResponse

| Field | Type | Standard | Status |
|---|---|---|---|
| `backFeedGiven` | yes / no | — | Optional |
| `resourceStatus` | text | — | Optional |
| `complaintCount` | integer | — | Optional |
...
| Field | Type | Standard | Status |
|---|---|---|---|
| `source` | MDMS / OMS / SCADA / RTDAS / AMI / MANUAL | — | Optional |
| `amispCode` | text | — | Optional |
| `detectionRef` | Identifier | — | Optional |
| `signal` | OutageSignal | — | Optional |
| `alarmRefs` | list of OutageAlarmRef | — | Optional |
...
| `feederStatus` | ENERGIZED / DE_ENERGIZED / UNKNOWN | — | Optional |
| `diPort` | text | — | Optional |
| `rawCode` | text | — | Optional |
...
| Field | Type | Standard | Status |
|---|---|---|---|
| `scheme` | METER_SERIAL / MRID / GIS_FEATURE_ID / SERVICE_DELIVERY_POINT / FEEDER / SUBSTATION / DT / CONSUMER_NUMBER / ORG / DID / OTHER | MRID: CIM (IEC 61968/61970); DID: W3C DID Core | Mandatory |
