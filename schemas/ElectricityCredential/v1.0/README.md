...
Credential revocation is managed via DeDi. See [Energy Credentials — Revoke](../../../how-you-implement-ies/issue-credentials.md#id-3.8-revoke) for the publication flow.
