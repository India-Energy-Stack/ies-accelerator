...
| Field | Type | Standard | Status |
|---|---|---|---|
| `issuedBy` | uri | — | Mandatory |
| `subjectId` | text | — | Mandatory |
...
| `energyResources` | list of EnergyResource | — | Mandatory |
| `consumptionProfiles` | list of ConsumptionProfile | — | Optional |
...
| `make` | text | — | Optional |
| `model` | text | — | Optional |
| `ratedPower` | QVPower | — | Optional |
| `maxImport` | QVPower | — | Optional |
| `maxExport` | QVPower | — | Optional |
| `telemetryProvider` | text | — | Optional |
| `commissioningDate` | date-time | — | Optional |
...
| `commissioningDate` | date-time | — | Optional |
| `location` | Location | — | Optional |
| `meterCapability` | Electromechanical / CMRI / AMR / AMI | — | Optional |
| `energyDirection` | Forward / Reverse / Bidirectional / Net | — | Optional |
| `functions` | list of ToU / NetMetering / MaxDemand / LoadControl / TamperDetection / PowerQuality / EventLogging | — | Optional |
| `feeder` | text | — | Optional |
| `bus` | text | — | Optional |
| `communicationTechnology` | PLC / RF_Mesh / GPRS / NB-IoT / LoRa / ZigBee / Other | — | Optional |
| `applicationProtocol` | DLMS_COSEM / ANSI_C12_18 / IEC_61850 / Modbus / Other | — | Optional |
...
| `commissioningDate` | date-time | — | Optional |
| `location` | Location | — | Optional |
| `storageCapacity` | QVEnergy | — | Optional |
| `storageType` | LithiumIon / LeadAcid / FlowBattery / NaS / NiCd / Flywheel / Other | — | Optional |
| `stateOfHealthPct` | number | — | Optional |
...
| `commissioningDate` | date-time | — | Optional |
| `location` | Location | — | Optional |
| `connectorType` | Type1 / Type2 / CCS1 / CCS2 / CHAdeMO / GB_T / NACS / Other | — | Optional |
| `controlProtocol` | OCPP_1.6 / OCPP_2.0.1 / OCPP_2.1 / ISO_15118_2 / ISO_15118_20 / Other | — | Optional |
| `v2xProtocol` | CHAdeMO_V2G / CCS_BPT / ISO_15118_20_AC_BPT / ISO_15118_20_DC_BPT / Other | — | Optional |
...
| `commissioningDate` | date-time | — | Optional |
| `location` | Location | — | Optional |
| `ratedApparentPower` | QVApparentPower | — | Optional |
| `maxReactivePower` | QVReactivePower | — | Optional |
| `minReactivePower` | QVReactivePower | — | Optional |
| `rideThroughCategory` | CategoryI / CategoryII / CategoryIII | — | Optional |
| `operatingMode` | GridFollowing / GridForming / Standby | — | Optional |
| `voltVarEnabled` | yes / no | — | Optional |
| `freqDroopEnabled` | yes / no | — | Optional |
| `enterServiceRampTimeSec` | number | — | Optional |
...
| `commissioningDate` | date-time | — | Optional |
| `location` | Location | — | Optional |
| `controlProtocol` | OpenADR_2.0b / OCPP_2.0.1 / SunSpec_Modbus / EEBus / Modbus / Other | — | Optional |
| `loadCategory` | Heating / Cooling / WaterHeating / Lighting / EV / Industrial / Other | — | Optional |
...
| `commissioningDate` | date-time | — | Optional |
| `location` | Location | — | Optional |
| `nominalVoltage` | QVVoltage | — | Optional |
| `zone` | text | — | Optional |
| `substationId` | text | — | Optional |
| `feederCode` | text | — | Optional |
...
| Field | Type | Standard | Status |
|---|---|---|---|
| `type` | SOLAR_PV / SOLAR / WIND / HYDRO / BIOGAS / CHP / FUEL_CELL | — | Optional |
...
| Field | Type | Standard | Status |
|---|---|---|---|
| `type` | EV_CHARGER / EV_V2G | — | Optional |
...
| Field | Type | Standard | Status |
|---|---|---|---|
| `type` | SMART_HVAC / SMART_WATER_HEATER / CONTROLLABLE_LOAD | — | Optional |
...
| Field | Type | Standard | Status |
|---|---|---|---|
| `type` | DT / BUS / FEEDER / MICROGRID | — | Optional |
...
|---|---|---|---|
| `id` | text | — | Mandatory |
| `subResources` | list of — | — | Optional |
| `parentResources` | list of text | — | Optional |
...
| `coordinates` | list of — | — | Optional |
| `geometries` | list of GeoJSONGeometry | — | Optional |
| `bbox` | list of number | — | Optional |
