...
| `premisesType` | Residential / Commercial / Industrial / Agricultural | — | **Optional** |
...
| `installationAddress` | Location | — | **Mandatory** |
...
|---|---|---|---|
| `id` | text | — | **Optional** |
| `type` | METER / DT / BUS / FEEDER / SOLAR / SOLAR_PV / WIND / HYDRO / BIOGAS / CHP / FUEL_CELL / BATTERY / BESS / EV_CHARGER / EV_V2G / SMART_HVAC / SMART_WATER_HEATER / CONTROLLABLE_LOAD / MICROGRID | — | **Optional** |
| `attributes` | object | — | **Optional** — All non-topological attributes. CommonResourceAttributes (make, model, ratedPowerKw, energyCapacityKwh, telemetryProvider) plus type-specific fields (meterType, gps, location, feeder, bus, commissioningDate, storageType, …). |
| `subResources` | list of text or EnergyResource | — | **Optional** |
...
| Field | Type | Standard | Description |
|---|---|---|---|
| `streetAddress` | text | — | **Optional** — Building name/number and street. |
| `extendedAddress` | text | — | **Optional** — Apt, suite, floor, or C/O. |
| `addressLocality` | text | — | **Optional** — City or locality. |
| `addressRegion` | text | — | **Optional** — State, region or province. |
| `addressCountry` | text | — | **Optional** — ISO 3166-1 alpha-2 country code. |
...
| `coordinates` | list of — | — | **Optional** — Coordinates per RFC 7946. For a Point: [longitude, latitude]. |
