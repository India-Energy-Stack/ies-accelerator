...
| `payloadDescriptorSetRef` | text | — | Optional |
...
| `serviceDeliveryPointRefs` | IdentifierList | — | Optional |
| `payloadDescriptorSetRef` | text | — | Optional |
| `compactSequenceRef` | text | — | Optional |
...
| `energyCharges` | number | — | Optional |
| `fixedCharges` | number | — | Optional |
| `otherCharges` | number | — | Optional |
| `prepaidBalance` | number | — | Optional |
...
| `name` | text | — | Optional |
| `consumerCategory` | text | — | Optional |
| `sanctionedLoadKw` | number | — | Optional |
| `billingCycleDay` | integer | — | Optional |
| `paymentMode` | PREPAID / POSTPAID | — | Optional |
| `connectionType` | Single-phase / Three-phase | — | Optional |
| `contractMaxDemandKw` | number | — | Optional |
| `tariffCategoryCode` | text | — | Optional |
| `sanctionedExportLoadKw` | number | — | Optional |
...
| `meterRefs` | IdentifierList | — | Mandatory |
| `parentResources` | list of Identifier | — | Optional |
| `telemetryProvider` | text | — | Optional |
| `commissioningDate` | date-time | — | Optional |
| `generationCapacityKw` | number | — | Optional |
| `storageCapacityKw` | number | — | Optional |
