...
|---|---|---|---|
| `resources` | list of uri | — | Mandatory |
| `scope` | ResourceOnly / ResourceAndChildren / ChildrenOnly | — | Mandatory |
| `from` | date-time | — | Mandatory |
| `duration` | duration | — | Mandatory |
| `maxRecordsShared` | integer | — | Optional |
| `includeDetails` | list of ProfileRequest | — | Optional |
...
| `values` | list of text | — | Optional |
| `requestedMode` | READING / USAGE | — | Optional |
