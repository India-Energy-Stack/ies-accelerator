...
|---|---|---|---|
| `resources` | list of uri | — | **Mandatory** — List of resource identifiers (e.g., meter DIDs, service point IDs, or customer IDs) to query. |
| `scope` | ResourceOnly / ResourceAndChildren / ChildrenOnly | — | **Mandatory** — Defines the hierarchical scope of the query relative to the target resources. |
...
| `includeDetails` | list of ProfileRequest | — | **Optional** — List of specific profile types and the data requested within them. |
...
| `values` | list of text | — | **Optional** — List of requested reading/OBIS short codes or value names. |
| `requestedMode` | READING / USAGE | — | **Optional** — The specific mode requested for these values. Defaults to the code's default mode if omitted. |
