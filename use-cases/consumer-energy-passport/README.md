...
| Block | Used for |
|---|---|
| [Identifiers and Addressing](../../what-ies-provides/identifiers/README.md) | DISCOM's `did:web`; consumer's wallet `did:key`; asset / meter / connection DIDs that appear inside the credential |
...
| [Holder binding](../../what-ies-provides/identifiers/README.md#appendix-f-binding-the-credential-to-a-holder-identity) | Wallet-DID binding pattern; presentation-time challenge / VP proof |
...
1. **Register** — set up the DISCOM `did:web` and run OpenCred → [Setup Register](../../how-you-implement-ies/setup-register.md); [Energy Credentials — Set up OpenCred](../../what-ies-provides/energy-credentials/README.md#set-up-opencred-and-publish-your-did-web).
2. Decide your identity-proofing method (DigiLocker pull, offline-KYC XML, in-person KYC, record-match) and document it for privacy review — see [Identifiers — Identity-proofing at issuance](../../what-ies-provides/identifiers/README.md#before-you-bind-anything-identity-proofing-at-issuance).
3. **Exchange** — issue the Passport via [Energy Credentials — Issue your first credential](../../what-ies-provides/energy-credentials/README.md#issue-your-first-credential), setting `credentialSubject.id` to the wallet DID and populating `customerProfile.idRef` with the government-ID reference.
...
**Step 0 — base issuance in place.** Complete [Energy Credentials → Setup checklist](../../what-ies-provides/energy-credentials/README.md#setup-checklist).
...
- [Identifiers — Holder binding patterns](../../what-ies-provides/identifiers/README.md#appendix-f-binding-the-credential-to-a-holder-identity)
