...
| [Issue Credentials](../../how-you-implement-ies/issue-credentials.md) | The single home for signing, verifying, and revoking — including the [Consumer Energy Passport variant](../../what-ies-provides/discover-exchange.md#variants-same-schemas-different-issuance-shapes) under "Credential variants" |
...
- [Energy Credentials — Credential variants](../../what-ies-provides/discover-exchange.md#variants-same-schemas-different-issuance-shapes) — where the Passport variant is documented
