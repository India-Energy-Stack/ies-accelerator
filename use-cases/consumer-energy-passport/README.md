...
| [Energy Credentials](../../how-you-implement-ies/energy-credentials/README.md) | The single home for signing, verifying, and revoking — including the [Consumer Energy Passport variant](../../how-you-implement-ies/energy-credentials/README.md#credential-variants) under "Credential variants" |
...
| [DigiLocker delivery](../../how-you-implement-ies/energy-credentials/digilocker.md) | The bulk delivery channel for Indian consumers; for many use cases DigiLocker's Aadhaar pull also acts as the identity-binding step |
...
4. Deliver into the consumer's DigiLocker or wallet → [DigiLocker delivery](../../how-you-implement-ies/energy-credentials/digilocker.md).
...
- [Energy Credentials — Credential variants](../../how-you-implement-ies/energy-credentials/README.md#credential-variants) — where the Passport variant is documented
