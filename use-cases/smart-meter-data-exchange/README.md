...
| Meter | `did:web` under DISCOM domain | `did:web:ies.discom.example:assets:meter:NM-44091234` |
| Distribution transformer | `did:web` under DISCOM domain | `did:web:ies.discom.example:assets:dt:DT-11KV-F02-452` |
| Feeder | `did:web` under DISCOM domain | `did:web:ies.discom.example:assets:feeder:F02` |
