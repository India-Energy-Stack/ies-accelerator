...
**The reference for how Indian smart-meter terminology — OBIS codes, IS 15959 profile buffers, IS 15959 event IDs, CIM master data — maps onto the [`MeterData`](../../schemas-ies/MeterData.md) schema (this page is pinned to the current `v0.6` shape) carried by IES Data Exchange.**
...
- [`MeterData`](../../schemas-ies/MeterData.md) — schema, examples, user guide, reference guide (mappings on this page are pinned to `v0.6`)
