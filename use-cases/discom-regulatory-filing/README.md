...
| [Registries](../../registries/README.md) | For Beckn message-signature verification: DISCOM and SERC subscriber records resolved via DeDi / `fabric.nfh.global`. The IES-curated [DISCOM reference registry](../../registries/required-registries.md#discom-reference-registry) and [Regulator reference registry](../../registries/required-registries.md#regulator-reference-registry) provide the Beckn network trust boundary. |
