...
Mirrors the [Data Exchange Quick Start](../../data-exchange/README.md#quick-start-run-a-local-exchange-in-10-minutes). Everything below assumes you've already followed [Data Exchange — Checklist](../../data-exchange/README.md#checklist) Stages 0–2 (devkit running, DeDi subscriber record, signing key).
