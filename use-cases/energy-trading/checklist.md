...
*Plain-English rollout checklist for a trading platform vendor (BAP or BPP), a regulated Ledger Provider (LP), or a discom standing up [Energy Trading](./README.md) on the IES network. Items are use-case-specific additions on top of the canonical [Data Exchange — Checklist](../../data-exchange/README.md#checklist); follow that one first.*
...
If you have already onboarded any Beckn flow on this network, reuse the same identity. New entrants follow [Data Exchange — Checklist → Stage 2 (Network identity)](../../data-exchange/README.md#stage-2-network-identity-dedi).
