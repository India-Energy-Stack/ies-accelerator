...
| **[Exchange](exchange.md)** | How data moves once discovered — B2B payloads carried over the same signed Beckn channel, the schemas that shape them, and where B2C verifiable credentials fit. |
