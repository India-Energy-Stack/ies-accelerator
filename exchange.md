...
For the step-by-step setup, follow **[How you implement IES → Build your Internal-facing Adapter](implementation/build-adapter.md)**.
...
To set up the Part-2 mapping hands-on: **[Build your Internal-facing Adapter](implementation/build-adapter.md)**.
