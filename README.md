...
| [IES Pathways](./pathways/README.md) | Structured, step-by-step onboarding roadmaps for DISCOMs, regulators, and other sector participants to adopt capabilities |
