...
supports, the schema itself, and the standards it builds on.

Submitting opens a short form on GitHub. When you click **Submit new issue**, your
answers (name, organization, contact details, use case, the proposed schema, standards,
and any additional material) are captured as a tracked proposal issue our working group reviews.
