...
### ⚠️ Caution
> **Batch Telemetry Latency**: MDM database queries can be slow and can violate your ONIX adapter's configured transaction timeout (the sandbox config defaults to 30 seconds). Ensure your telemetry API is highly optimized.
